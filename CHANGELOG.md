...
- Recompiled plugin with Go version `1.24`. ([#40](https://github.com/turbot/steampipe-plugin-env0/pull/40))
- Recompiled plugin with [steampipe-plugin-sdk v5.13.1](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5131-2025-09-25) that addresses critical and high vulnerabilities in dependent packages. ([#41](https://github.com/turbot/steampipe-plugin-env0/pull/41))
